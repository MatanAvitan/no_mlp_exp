# 12-layer, 16-head No-MLP transformer configuration (wider)
# n_embd = 1280, value_dim = 5120
# Conservative batch sizing for local 4x A100

out_dir = "out_no_mlp_12L_16H_1280"
eval_interval = 2000
eval_iters = 200
log_interval = 1
...
wandb_run_name = "no_mlp_12L_16H_d5120_w1280_4gpu"
...
gradient_accumulation_steps = (
    4  # Effective batch size = 32 * 4 * 4 = 512 (must be divisible by 4 GPUs)
)
